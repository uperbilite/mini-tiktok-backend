...
ReadStructEndError:
	return thrift.PrependError(fmt.Sprintf("%T read struct end error: ", p), err)
RequiredFieldNotSetError:
	return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_GetFavoriteCountRequest[fieldId]))
}
...
var GetFavoriteCountResponse_BaseResp_DEFAULT *BaseResp

func (p *GetFavoriteCountResponse) GetBaseResp() (v *BaseResp) {
	if !p.IsSetBaseResp() {
		return GetFavoriteCountResponse_BaseResp_DEFAULT
	}
	return p.BaseResp
}

func (p *GetFavoriteCountResponse) GetFavoriteCount() (v int64) {
	return p.FavoriteCount
}
func (p *GetFavoriteCountResponse) SetBaseResp(val *BaseResp) {
	p.BaseResp = val
}
func (p *GetFavoriteCountResponse) SetFavoriteCount(val int64) {
	p.FavoriteCount = val
}
...
func (p *GetFavoriteCountResponse) IsSetBaseResp() bool {
	return p.BaseResp != nil
}
...
ReadStructEndError:
	return thrift.PrependError(fmt.Sprintf("%T read struct end error: ", p), err)
RequiredFieldNotSetError:
	return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_GetFavoriteCountResponse[fieldId]))
}
...
func (p *GetFavoriteCountResponse) ReadField2(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadI64(); err != nil {
		return err
	} else {
		p.FavoriteCount = v
...
func (p *GetFavoriteCountResponse) writeField2(oprot thrift.TProtocol) (err error) {
...
func (p *GetFavoriteCountResponse) Field1DeepEqual(src *BaseResp) bool {
...
func (p *GetFavoriteCountResponse) Field2DeepEqual(src int64) bool {

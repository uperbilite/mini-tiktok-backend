...
type CreateUserRequest struct {
	Username string `thrift:"username,1" json:"username" query:"username" vd:"len($) > 0 && len($) <= 32"`
	Password string `thrift:"password,2" json:"password" query:"password" vd:"len($) > 0 && len($) <= 32"`
}
